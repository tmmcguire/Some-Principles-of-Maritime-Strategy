...
theory of tactics had existed in 1780, and if Captain \idx[Carkett]{Carkett, Captain Robert} had had a
...
value.''\footnote{Clausewitz, \emph{\idx[On War]{Clausewitz, General Karl von!\emph{On War}}}, p. ix. The references are  
...
overthrown---an idea in which \idx[Cromwell]{Cromwell, Oliver} had anticipated Napoleon by a century
...
Carl von \idx[Clausewitz]{Clausewitz, General Karl von}, a man whose arduous service on the Staff and the
...
\idx[Gneisenau]{Gneisenau, Field Marshal August von}, he had served on the Staff of \idx[Blücher]{Blucher, Field Marshal Gebhard von@Bl\"ucher, Field Marshal Gebhard von} in 1813, he had been Chief
of the Staff to Wallmoden in his campaign against \idx[Davout]{Davout, Louis-Nicolas} on the Lower
Elbe, and also to the Third \idx{Prussia}n Army Corps in the campaign of 1815.
...
\idx[Gneisenau]{Gneisenau, Field Marshal August von}. For the fifty years that followed his death his theories and
...
his classical work \emph{\idx[On War]{Clausewitz, General Karl von!\emph{On War}}} and the \emph{Notes} regarding it      
...
longer capable of resistance. This \idx[Clausewitz]{Clausewitz, General Karl von} called ``\idx{Absolute    
...
In short, \idx[Clausewitz]{Clausewitz, General Karl von!theory}'s difficulty in adopting his abstract theory as a
...
between the political and the military exigencies. But \idx[Clausewitz]{Clausewitz, General Karl von!theory} held that
...
was Napoleon's or \idx[Moltke]{Moltke, General von}'s way. He will ask what is the political object of
...
same nature as those in which Napoleon's and \idx[Moltke]{Moltke, General von}'s methods were
...
Hence, says \idx[Clausewitz]{Clausewitz, General Karl von!theory}, the first, the greatest and most critical decision
...
\idx[Jomini]{Jomini, General Baron de}, his great contemporary and rival, though proceeding by a less
...
\idx[Clausewitz]{Clausewitz, General Karl von}. It was obtained mainly on the Staff of Marshal \idx[Ney]{Ney, Marshal Michael} and
...
prevent the \idx{Mediterranean} becoming a French lake by the union of the French
and Spanish crowns, but the method by which we succeeded in achieving our
end was to seize the naval positions of \idx{Gibraltar} and \idx{Minorca}, and so in
practice our method was positive. Again, in the late Russo-Japanese War the
main object of Japan was to prevent \idx{Korea} being absorbed by Russia. That
aim was preventive and negative. But the only effective way of securing her
aim was to take \idx{Korea} herself, and so for her the war was in practice
positive.
...
instance, in \idx[Frederick]{Frederick the Great} the Great's best-known operations, or in Admiral
Tegetthoff's brilliant counterstroke at \idx{Lissa}, or our own operations
...
we have seen the Japanese at the \idx{Elliot Islands} preparing a real defensive
position to cover the landing of their Second Army in the \idx[Liaotung]{Liaotung Peninsula}
...
at moments of exhaustion, as the Dutch did at Sole Bay and in the \idx{Medway}.
...
\idx[Jomini]{Jomini, General Baron de} and \idx[Clausewitz]{Clausewitz, General Karl von}, the two apostles of the Napoleonic method. The
...
more appropriate \idx[Jomini]{Jomini, General Baron de} cites Napoleon's campaign against Russia in 1812.
...
Seeing how high was Napoleon's opinion of \idx[Jomini]{Jomini, General Baron de} as a master of the     
...
\idx{Belgium} he drew up a war plan, and it was designed not on the Napoleonic
...
time was on the lines which \idx[Jomini]{Jomini, General Baron de} held should have been Napoleon's in
...
% 
%    Development of Clausewitz's and \idx[Jomini]{Jomini, General Baron de}'s
...
Napoleon's empire. She sent her main army under the \idx[Archduke Charles]{Charles of Austria} to
...
enemy's country,'' such as Silesia and Saxony for \idx[Frederick]{Frederick the Great} the Great,
...
the \idx[Peninsula]{Iberian Peninsula}, and Napoleon's dreams of Asiatic conquest, pronouncing such
...
such cases as \idx{Canada} and \idx{Havana} in the Seven Years' War, and \idx[Cuba]{Cuba} in the
...
in Wellington's operations in the \idx[Peninsula]{Iberian Peninsula}, they became indistinguishable
...
the assistance we sent to \idx[Frederick]{Frederick the Great} the Great in the Seven Years' War. At
...
engaged in an unlimited war in which the continued existence of \idx{Prussia} was
...
manner, of which \idx[Marlborough]{Marlborough, John, Duke of}'s campaigns were typical, and they exhibit the
special form which \idx[Marlborough]{Marlborough, John, Duke of} would have chosen had political exigencies
permitted and which was to become characteristic of British effort from
\idx[Pitt]{Pitt, William, Earl of Chatham}'s time onward. In the method of our greatest War Minister we have not
...
of securing \idx{Holland}, and also complete touch with the sea, but our theatre
...
result was purely defensive. It was not till the \idx[Peninsular]{Iberian Peninsula} War developed
...
failure ensued. Only in \idx{Portugal}, the defence of which was a true limited
...
from unlimited war, for the conditions required by \idx[limited war]{Limited War}          
...
or confining ourselves to coastal diversion, as we did at \idx[Frederick]{Frederick the Great} the
...
the higher method. \idx[Frederick]{Frederick the Great} the Great was the first great soldier to
...
1805 he called \idx{Craig's expedition} a ``pygmy combination,'' yet the
...
\idx{Copenhagen} in 1807. It failed at the \idx{Dardanelles} because fleet and army
were separated; it succeeded at \idx{Lisbon} and at \idx{Cadiz} by demonstration alone.
...
their utmost military strength in the \idx[Peninsula]{Iberian Peninsula}, and so long as a potent
and growing fleet remained in the \idx{North Sea} it would always act as an
...
in transports at the \idx[Downs]{Downs, the},'' the Emperor wrote, ``the English can paralyse
...
The concentration of the British efforts in the \idx[Peninsula]{Iberian Peninsula} apparently
...
opportunities may occur late or early. As both Lord \idx[Ligonier]{Ligonier, General Lord} and Wolfe laid
...
\chapter{Conditions of Strength in \idx[Limited War]{Limited War}}
...
it was also, like \idx[Frederick]{Frederick the Great}'s seizure of Saxony, a sound piece of       
...
of the two Russian arsenals at \idx{Port Arthur} and Vladivostock, with a     
...
sea, and the position of Japan in \idx{Korea} was rendered as impregnable as that
...
blow which Admiral Togo delivered at \idx{Port Arthur} to cover the primary
...
is, that so long as the Japanese acted on the principles of \idx[limited war]{Limited War}, as
...
\idx{Command of the Sea}, therefore, means nothing but the control of maritime
\idx[communications]{Communications, maritime}, whether for commercial or military purposes. The object of
naval warfare is the control of \idx[communications]{Communications, maritime}, and not, as in land
...
\idx[communications]{Communications, maritime}, but they are \idx[communications]{Communications, maritime} in another sense. The phrase
refers to the \idx[communications]{Communications, maritime} of the army alone, and not to the wider
\idx[communications]{Communications, maritime} which are part of the life of the nation.

But on land also there are \idx[communications]{Communications, maritime} of a kind which are essential to
national life---the internal \idx[communications]{Communications, maritime} which connect the points of
...
sufficient force to complete the occupation of his inland \idx[communications]{Communications, maritime}
...
maritime \idx[communications]{Communications, maritime} and closing the points of distribution in which
...
\idx[communications]{Communications, maritime}, the analogy between command of the sea and the conquest of
...
\idx[communications]{Communications, maritime} it must carry with it the right to forbid, if we can, the
passage of both public and private property upon the sea. Now the only
means we have of enforcing such control of commercial \idx[communications]{Communications, maritime} at sea
...
for attempting to use the \idx[communications]{Communications, maritime} of which he does not hold the
...
To make the position clear we should say ``\idx{Commerce prevention}.''
...
often, and particularly in the \idx{Mediterranean} and the West Indies, with
...
In a similar way \idx[privateering]{Privateering} always had a debilitating effect upon our own
...
strategical control of the enemy's maritime \idx[communications]{Communications, maritime}. A riper and
sounder view of war revealed that what may be called tactical commercial
\idx[blockade]{Blockade!tactical}---that is, the \idx[blockade]{Blockade!commercial} of ports---could be extended to and
supplemented by a strategical \idx[blockade]{Blockade!strategical} of the great trade routes. In moral
principle there is no difference between the two. Admit the principle of
tactical or close \idx[blockade]{Blockade!close}, and as between belligerents you cannot condemn
the principle of strategical or distant \idx[blockade]{Blockade!distant}. Except in their effect
...
\idx[communications]{Communications, maritime}, without which no conquest is complete and no effective war
...
\idx[communications]{Communications, maritime} at sea, you must also refuse the right on land. If you admit
...
the hostile main army,'' says Von der \idx[Goltz]{Goltz, General von der}, ``we still have the forcing of a
...
To elucidate the point, it must be repeated that maritime \idx[communications]{Communications, maritime!common theory of},
which are the root of the idea of command of the sea, are not analogous to
military \idx[communications]{Communications, maritime} in the ordinary use of the term. Military
\idx[communications]{Communications, maritime} refer solely to the army's lines of supply and retreat.
Maritime \idx[communications]{Communications, maritime!common theory of} have a wider meaning. Though in effect embracing
...
\idx[communications]{Communications, maritime} are on a wholly different footing from land \idx[communications]{Communications, maritime}.
At sea the \idx[communications]{Communications, maritime} are, for the most part, common to both
...
ashore. Since maritime \idx[communications]{Communications, maritime} are common, we as a rule cannot
attack those of the enemy without defending our own. In military operations
the converse is the rule. Normally, an attack on our enemy's \idx[communications]{Communications, maritime}
...
and America ran down from the Channel mouth past \idx[Finisterre]{Finisterre, Cape} and St.
...
an \idx{India}man in sight of the \idx[Lizard]{Lizard, the}, while Wellington's complaints       
...
second Dutch war. \idx[Monk]{Monk, George, Duke of Albemarle} and Rupert were in command of the main fleet, which
from its mobilisation bases in the Thames and at Spithead had concentrated
in the \idx[Downs]{Downs, the}. There they were awaiting De Ruyter's putting to sea in a
...
divided, and Rupert went back to \idx{Portsmouth} to cover that position in case
...
recalled. He succeeded in rejoining \idx[Monk]{Monk, George, Duke of Albemarle} after his action with De Ruyter
...
sea, and it is certain \idx{Portsmouth} and the Isle of Wight would have lain
...
it was a necessity. The fault in \idx[Monk]{Monk, George, Duke of Albemarle}'s and Rupert's case was that they
...
and \idx[Monk]{Monk, George, Duke of Albemarle} should not have engaged deeply till he felt Rupert at his elbow.
...
\idx[Kempenfelt]{Kempenfelt, Admiral Richard}'s principle, would have been to hang on De Ruyter so as to
...
before \idx{Ferrol} and Rochefort. With a further squadron off the coast of
...
concentration was in the \idx{Mediterranean}, whose centre under Nelson was at
Sardinia. It had outlying sub-centres at \idx{Malta} and \idx{Gibraltar}, and covered
the whole ground from Cape St. Vincent outside the Straits to Toulon,
Trieste, and the \idx{Dardanelles}. When war broke out with Spain in 1804, it was
...
and whose northern limit was Cape \idx[Finisterre]{Finisterre, Cape}, where it joined the Ushant
...
cruiser centre at the \idx{Channel Islands}, the \idx[Downs]{Downs, the} and Ushant concentrations
could rapidly cohere. Similarly the \idx{Cadiz} concentration was linked up with
that of Ushant at \idx[Finisterre]{Finisterre, Cape}, and but for personal friction and repulsion,
...
and \idx[Bruix]{Bruix, Admiral} had no doubt of it, and the knowledge overpowered Villeneuve when
...
\idx{Ferrol} and Rochefort. In his eyes, as well as those of the British
...
his heart to fail. It was the news that Nelson had reappeared at \idx{Gibraltar},
...
concentration was stopped. Villeneuve fell back on \idx{Cadiz}, and the problem
...
West Indies at hand, and there was our expedition in the \idx{Mediterranean} in
jeopardy, and another on the point of sailing from Cork. Neither \idx[Barham]{Barham, Admiral Sir Charles Middleton} at
the Admiralty nor \idx[Cornwallis]{Cornwallis, Admiral Sir William} in command off Ushant hesitated an hour. By a
...
combined effort against our West \idx{India}n islands, and particularly \idx{Jamaica}.
...
While Rodney took the offensive area, Lord \idx[Howe]{Howe, Admiral Earl} was given the other. His
...
attack on the West Indies with an attempt to control the \idx{North Sea}, and
...
thereby force us to neglect the West \idx{India}n area and the two Spanish
...
or reserve at Spithead, a squadron in the \idx[Downs]{Downs, the} to watch the Texel for the
...
Spithead. He was away three weeks, and returned with a French East \idx{India}
...
come home. Ross in the \idx{North Sea} had but four of the line to watch the
...
the 10th \idx[Howe]{Howe, Admiral Earl} sailed with \idx[Barrington]{Barrington, Admiral Samuel} and the bulk of the fleet to join Ross
in the \idx[Downs]{Downs, the}, while \idx[Kempenfelt]{Kempenfelt, Admiral Richard} again took the Ushant position. Only about
...
retire up Channel under the English coast and join hands with \idx[Howe]{Howe, Admiral Earl}. In
...
12th, ``being fifteen leagues S.S.E. from Scilly,'' idx[Langara]{Langara, Admiral Don Juan} with thirty-six
...
\idx[Kempenfelt]{Kempenfelt, Admiral Richard}'s well-known exposition,\footnote{See post, pp. 222-24.} he  
...
\idx[blockade]{Blockade!of the Texel} of the Texel and cover the arrival of the autumn convoys from  
...
Napoleon's or \idx[Frederick]{Frederick the Great}'s, or that it was a foreign importation at all. In
...
throughout by their battle-fleets, and under \idx[Monk]{Monk, George, Duke of Albemarle} and Rupert at least those
...
could not tell whether the blow was to fall in the Channel or \idx{Ireland} or
...
under which \idx[Byng]{Byng, Admiral Sir George} and \idx[Calder]{Calder, Admiral Sir Robert} were condemned; and in the apotheosis of Nelson
...
In the former case the Americans took up arms in order to liberate \idx[Cuba]{Cuba}
...
\idx[Coruña]{Coru\~na}, where it was known the \idx[Armada]{Armada, Spanish}, after an abortive start from \idx{Lisbon},
...
in the \idx{Mediterranean} that forced from Napoleon his reckless order for
Villeneuve to put to sea from \idx{Cadiz}, and so solved the problem out of which
Nelson had seen no issue. \idx{Lissa} may be taken as an analogous case. But
...
the memories of \idx{La Hogue}, Quiberon, and the \idx{Nile} to assure us that sooner
...
need to raise the Rochefort \idx[blockade]{Blockade}. \idx[Barham]{Barham, Admiral Sir Charles Middleton} would have had enough ships at
his command to preserve the whole of his \idx[blockade]{Blockade}s, as he had intended to
do till the \emph{\idx[Curieux]{Curieux@\emph{Curieux}}'s} news of Villeneuve's precipitate return forced his
...
\idx[Barham]{Barham, Admiral Sir Charles Middleton} was far too astute to play into Napoleon's hands, and by blindly
...
\idx[blockade]{Blockade!open}, and Nelson's protest against the consequent confusion of thought
...
A leading case of such an open \idx[blockade]{Blockade!open} was Nelson's disposition of his
fleet off \idx{Cadiz} when he was seeking to bring Villeneuve to action in 1805.
...
a commercial \idx[blockade]{Blockade!commercial} of the adjacent ports in hope of starving Villeneuve
...
usual French route from \idx{Brest} to the West Indies.
...
the \idx[blockade]{Blockade} and run to Torbay or \idx{Plymouth}. Such temporary reversions to
...
he decided on open \idx[blockade]{Blockade!open} based on a general reserve at Spithead or St.
...
\idx{Gibraltar} from time to time prevented the Western Squadron devoting itself
...
\idx{Brest} which might equally well leave the Texel or \idx{Dunkirk} was just what the
...
The analogy between the conditions of the \idx[blockade]{Blockade} which St. Vincent
...
were pressing close \idx[blockade]{Blockade!close} to its utmost limit of rigour, Nelson in the
...
invasion. Just a year before Trafalgar was fought, \idx[Cornwallis]{Cornwallis, Admiral Sir William} pressed   
...
Japanese \idx[blockade]{Blockade!of Port Arthur} of \idx{Port Arthur}, will its incidents be materially
...
for Villeneuve in the Gulf of \idx[Lyons]{Lyons, Admiral Sir Edmund} in 1805.
...
Lord \idx[Howe]{Howe, Admiral Earl} continues at Torbay, our \idx{Mediterranean} and \idx{Jamaica} convoys are in
...
Nelson's open \idx[blockade]{Blockade!open} amply secured.
...
\section{Defensive fleet operations---``a \idx[fleet in being]{Maxims!``Fleet in being''}''}
...
on \idx[Chateaurenault]{Chateaurenault, Admiral Comte de}, who with a slightly inferior squadron was at Toulon. It
was assumed he would probably make a push for \idx{Brest}, where the French main
fleet was mobilising under the Comte de Tourville, and \idx[Killigrew]{Killigrew, Admiral Henry} had orders
...
the \idx[command]{Command of the Sea} of the Channel before the concentration could take place and to
crush the British in detail. Accordingly, on June 13th, as soon as
\idx[Chateaurenault]{Chateaurenault, Admiral Comte de} had arrived, Tourville put to sea with some seventy of the
...
Shovel and the \idx{Plymouth} division by getting to the westward. If he found
...
Channel, but the invasion of \idx{Ireland} was in full progress, and all
...
Torrington's judgment it could be rendered innocuous by holding the \idx[command]{Command of the Sea}
...
admiral meant by ``A \idx[fleet in being]{Maxims!``Fleet in being''}.'' He thought that in Torrington's view a
fleet safe in port and not in contact with the enemy was ``in being,''
whereas Torrington had no such idea. As \idx[Nottingham]{Nottingham, Daniel Finch, Earl of} conceived the admiral's
...
\idx{Medway} or Thames, or get away without fighting.''
...
ships were safe in \idx{Plymouth}. In spite of Torrington's being forced to fight
...
of American Independence we have a memorandum of the subject by \idx[Kempenfelt]{Kempenfelt, Admiral Richard},
...
It was on these lines the war was conducted. The West \idx{India}n area, in which
...
the West Indies under the nose of De \idx[Guichen]{Guichen, Admiral Comte de} with an escort of nearly twice
his force.

Nelson certainly shared \idx[Kempenfelt]{Kempenfelt, Admiral Richard}'s views as to the possibilities of an
...
after Villeneuve's escape from the \idx{Mediterranean}, decided Sir John \idx[Orde]{Orde, Admiral Sir John} to
...
general power of holding such \idx[command]{Command of the Sea} in dispute, as Torrington used it.
...
squadrons of Shovel and \idx[Killigrew]{Killigrew, Admiral Henry}, and so far as commanding a line of
...
Torrington and developed by \idx[Kempenfelt]{Kempenfelt, Admiral Richard} goes no further than this, that
...
Ushant, that is, between the enemy and his base. Tourville's \idx[communications]{Communications, maritime}
...
Yet with the voice of Torrington, \idx[Kempenfelt]{Kempenfelt, Admiral Richard}, and Nelson in our ears, it
...
restless and vigilant counter-attack which \idx[Kempenfelt]{Kempenfelt, Admiral Richard} and Nelson regarded
...
comparative success of the opening Japanese attack on the \idx{Port Arthur}
...
was in favour of the Japanese. \idx[Orde]{Orde, Admiral Sir John}rs had been issued in the Russian
...
Japanese plan for securing ultimate \idx[command]{Command of the Sea} rested on their power of taking
...
out of \idx{Brest}.'' Similarly Commodore Warren in 1796, when he had the      
...
\idx[Keith]{Keith, Admiral Lord}'s orders when watching Napoleon's flotilla were to the same       
...
at least by the best men. When in 1805 Napoleon consulted \idx[Ganteaume]{Ganteaume, Admiral Comte} as to
...
Napoleon's invasion of \idx{Egypt}; and secondly, when, although the design was
...
\idx{Dunkirk}, and a French fleet was coming up the Channel to cover the passage.
...
case of Napoleon's invasion of \idx{Egypt}. But that operation belongs to an
...
\idx[Brest]{Brest!fleet} fleet after it entered the Channel and was to proceed to join the
...
Not knowing that \idx[Norris]{Norris, Admiral Sir John} was in the \idx[Downs]{Downs, the}, Saxe began immediately to embark
...
The \idx[Brest]{Brest!fleet} squadron had an equally narrow escape. Saxe and his staff having
...
On the morrow he heard that Roquefeuille was at \idx{Dungeness} with only fifteen
...
of Napoleon, was to gather the army at \idx{Ambleteuse} and \idx{Boulogne}, and to
...
fleet from the \idx{Mediterranean} and the West Indies.

The new feature, it will be observed, was that our covering fleet---that is,
the Western Squadron off \idx{Brest}---would have two cruiser \idx[blockade]{Blockade}s to secure,
...
Channel. With the \idx{Morbihan} force it was different. Any time that \idx[Hawke]{Hawke, Admiral Sir Edward} was
...
though the West \idx{India}n squadron got in, it proved, as in Napoleon's great
...
transports. \idx[Hawke]{Hawke, Admiral Sir Edward} was upon him at once, and the disastrous day of Quiberon
...
sea and seize \idx{Portsmouth} and the Isle of Wight. It was in the early summer
...
mouth of the Channel, and the \idx{North Sea} or Eastern Squadron with its
...
French ones north-about against our \idx{Baltic trade}. Like the Western
Squadron, it threw out divisions usually located at Yarmouth and \idx{Leith} for
...
approaching, and Villeneuve's return to \idx{Ferrol} from Martinique exposed them
...
points of lesser importance, such as Capes \idx[Finisterre]{Finisterre, Cape} and St. Vincent, were
...
the extension from \idx[Finisterre]{Finisterre, Cape} to St. Vincent, which Nelson advised.     
...
his navy, and being no longer able to dispute the \idx[command]{Command of the Sea}, he could do no
...
dispute the \idx[command]{Command of the Sea}. Whatever his strength, he must leave the \idx[command]{Command of the Sea} to
...
1812 with the United States, the West \idx{India}n and North American areas were
...
lies the only radical change in the problem. The East \idx{India}n seas were
...
retention of their armament by East \idx{India}men was the last survival of the
...
the relief ships of the East \idx{India}n station. As a rule, their escort proper
went no farther outward-bound than St. Helena, whence it returned with the
homeward-bound vessels that gathered there from \idx{India}, China, and the South
...
sufficiently covered by our Channel and \idx{Mediterranean} fleets occupying the
...
were operating against \idx{Barcelona}, Shovel was covering the amphibious siege
...
Japanese in the \idx[Liaotung]{Liaotung Peninsula} Peninsula, but the conditions were far more
...
In the Japanese operations against \idx{Manchuria} and the \idx[Kuantung]{Kuantung Peninsula} Peninsula
...
the traditional principle, dating from \idx[Drake]{Drake, Sir Francis}'s attack on San Domingo in
...
contrasted with the \idx{Lissa} episode at the end of the Austro-Italian War of
...
When in 1795 the expedition under Admiral~\idx[Christian]{Christian, Admiral Sir Hugh} and General~\idx[Abercromby]{Abercromby, General Sir Ralph} was being prepared for the West Indies, the admiral in       
...
because it was impossible to count on closing either \idx{Brest} or Toulon    
...
device appears in \idx[Drake]{Drake, Sir Francis}'s attack on San Domingo in 1585, an attack which
...
held \idx[Montcalm]{Montcalm, General Marquis de} away from Wolfe's landing place till a secure footing had
...
it was not till \idx[Montcalm]{Montcalm, General Marquis de} was face to face with Wolfe that he knew he had to
...
True Defensive means waiting for a chance to strike.
    ...
    \note When the Dutch burnt our ships at \idx{Chatham}, we were not acting on
...
are most highly developed in combined expeditions.
    ...
    acquire. Compare Rochefort Expedition (diversion) and \idx[Belleisle]{Belleisle, Marechal de}
...
\textbf{PROOF I.}---\emph{Deductive}.---We say the aim of Naval Strategy is to get \idx[command]{Command of the Sea}
...
\begin{enumerate}
  \item The prevention or securing of alliances (\emph{i.e.}, deterring or persuading neutrals as to participating in the war).
    ...
    \idx{Portugal} to the Grand Alliance. Operations of Nelson to maintain the
    ...
    Eastern \idx{Mediterranean}; the destruction of the Toulon Fleet was not.
...
\end{enumerate}
    ...
    unshaken Toulon Fleet. Japanese invasion of \idx{Manchuria}.
...
with bringing enemy to action if he comes out.
    ...
    \example \emph{Case} (1): First stage of Togo's \idx[blockade]{Blockade!of Port Arthur} of \idx{Port Arthur}.
...
We say the aim of Naval Strategy is to get \idx[command]{Command of the Sea} of the sea. This means
...
\example The operations of Rooke in the first years of the War of the
Spanish Succession, 1702-04, to secure the adhesion of Savoy and \idx{Portugal}
...
\idx{Mediterranean}; the destruction of the Toulon Fleet was not.
...
of the Seven Years' War, until \idx[Hawke]{Hawke, Admiral Sir Edward} and \idx[Boscawen]{Boscawen, Admiral Edward} obtained a decision by
defeating \idx[Conflans]{Conflans, Admiral Comte de} and De la Clue; also in the Great War up to Trafalgar.
...
%     on \idx[blockade]{Blockade}, 184, 186, 198-99, 208;
