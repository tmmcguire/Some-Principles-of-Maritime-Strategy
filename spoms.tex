...
\idx[Coru\~na]{Coru\~na}, where it was known the \idx[Armada]{Armada, Spanish}, after an abortive start from \idx{Lisbon},
...
to keep what was left of the \idx[Brest]{Brest!fleet} fleet in port. Our hope was by our
...
that the \idx[Brest]{Brest!fleet} fleet should be kept in port, and every time \idx[Ganteaume]{Ganteaume, Admiral Comte}
...
army to start from \idx{Dunkirk}, the covering fleet from \idx[Brest]{Brest!fleet}.
...
\section[Attack, defence, and expeditions]{Attack, defence, and support of military expeditions}
